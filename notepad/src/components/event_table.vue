<template>
    <section class="event-ball" :class="{'event-all-show': isShow}">
        <div class="table-box">
            ...
            <table class="event-table">
                ...
                <tbody>
                    <tr v-for="(value, index) in notepad">
                        ...
                        <td align="center" style="font-size: 0;"><button @click="showInput(index)">编辑</button><button class="del-btn" @click="showDialog(index, value.id)">删除</button></td>
                    </tr>
                </tbody>
            </table>
        </div>
